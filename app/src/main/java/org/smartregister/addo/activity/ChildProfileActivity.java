...
import org.smartregister.addo.presenter.ChildProfilePresenter;
            ...
            case JsonFormUtils.REQUEST_CODE_GET_JSON:
                if (resultCode == RESULT_OK) {
                    try {
                        ...
                        if (form.getString(JsonFormUtils.ENCOUNTER_TYPE).equals(org.smartregister.addo.util.Constants.EventType.UPDATE_CHILD_REGISTRATION)) {
